...
import os
os.chdir('C:/data/Mask_RCNN_2.1')

pip install -r requirements.txt

os.chdir('C:/data/Mask_RCNN_2.1/samples')
...
os.chdir('C:/data/Mask_RCNN_2.1') # mrcnn 를 import 하기위한 workspace path 설정
...
MODEL_DIR = os.path.join(ROOT_DIR, "samples\\mask_rcnn_balloon.h5") # 가중치를 사용하는 모델 실제 경로
